Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"165 96 179 255" // Highlight color
		...
		"G_TransparentMenuBG"	"35 34 32 150" // Transparent menu color
		"G_PanelBg"				"35 34 32 150" // Panel color
		"G_OpaquePanelBg"		"35 34 32 255" // Opaque Panel color
		"G_Warning"				"231 36 36 255" // Warning color
		"G_HealthValue"			"108 227 104 255" // Health value color
		"G_Overheal"			"97 213 242 255" // Overhealed health value color
		"G_LowHealthValue"		"248 255 56 255" // Low health value color
		"G_AmmoClipValue"		"255 255 255 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"255 255 255 255" // Ammo in reserve value color
		"G_LowAmmo"				"255 56 56 255" // Low ammo color
		...
		"G_CustomTargetID" 				"0 0 0 43" // Custom target id bg color
		"G_CustomBuildingStatusBg" 		"0 0 0 100" // Custom building status bg color
		"G_TargetHealthValue" 			"208 197 168 179" // Target ID health value color
		"G_TargetHealthValueShadow" 	"0 0 0 0" // Target ID health value shadow color
		...
		"G_Footer"					"31 31 31 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"235 235 235 255" // Footer text color
		"G_DimmFooterText"			"235 235 235 120" // Dimm Footer text color
		"G_OuterBorder"				"0 0 0 105" // Outer border color
		"G_InnerBorder"				"0 0 0 0" // Inner border color
		"G_KillfeedBlue"			"83 174 242 255" // Killfeed blue text
		"G_KillfeedRed"				"242 83 83 255" // Killfeed red text
		"G_KillfeedIcon"			"255 255 255 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"125 52 149 0" // Main Menu overlay color
		"G_MainMenuPanel"			"0 0 0 128" // Main Menu panel color
		"G_MainMenuButton"			"235 219 238 255" // Main Menu button color
		"G_MainMenuButtonHover"		"165 96 179 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"70 53 73 255" // Main Menu button text color
		...
		"G_BackpackItemBg"			"66 66 66 255" // Backpack item bg color
		"G_LoadoutItemBg"			"31 31 31 255" // Loadout item bg color
		"G_MenuBg"					"58 34 63 255" // Menu bg color
		"G_MenuText"				"234 216 238 255" // Menu text color
		"G_InputText"				"61 56 62 255" // Input text color
		"G_DimmInputText"			"61 56 62 100" // Dimm Input text color
		"G_DimmMenuText"			"234 216 238 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"35 34 33 255" // Item description panel bg
		"G_ButtonBg"				"22 22 22 255" // Button bg color
		"G_ButtonText"				"255 255 255 163" // Button text color
		"G_ButtonHoverBg"			"49 49 49 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 209" // Button hover text color
		"G_ButtonSelectedBg"		"94 59 218 255" // Button selected bg color
		"G_ButtonSelectedText"		"255 255 255 189" // Button selected text color
		...
		"G_ItemMeterBg"				"40 40 40 82" // Item meter bg
		"G_ItemMeterBorder"			"112 176 117 0" // Item meter border color
		...
		// Crosshairs
		"G_Crosshair1Color"		"245 79 255 255" // Crosshair1 color
		"G_Crosshair2Color"		"245 79 255 255" // Crosshair2 color
		"G_Crosshair3Color"		"245 79 255 255" // Crosshair3 color
		...
		"TFOrange"			"165 96 179 255" // Highlight color
		...
		"QualityColorNormal"					"245 245 245 255" // IQC Normal
		"QualityColorrarity1"					"60 131 61 255" // IQC Genuine
		"QualityColorrarity2"					"141 131 75 255"
		"QualityColorrarity3"					"204 204 250 255"
		"QualityColorrarity4"					"132 42 194 255" // IQC Unusual
		"QualityColorVintage"					"16 107 245 255" // IQC Vintage
		"QualityColorUnique"					"255 215 0 255" // IQC Unique
		"QualityColorCommunity"					"98 174 54 255" // IQC Community
		"QualityColorDeveloper"					"174 35 132 255" // IQC Valve
		"QualityColorSelfMade"					"98 174 54 255" // IQC Community
		"QualityColorCustomized"				"71 98 145 255"
		"QualityColorStrange"					"240 98 44 255" // IQC Strange
		"QualityColorCompleted"					"134 80 172 255"
		"QualityColorHaunted"					"33 242 174 255" // IQC Haunted
		"QualityColorCollectors"				"182 0 0 255" // IQC Collectors
		"QualityColorPaintkitWeapon"			"250 250 250 255" // IQC PaintkitWeapon
		
		"DimmQualityColorNormal"				"245 245 245 100" // Dimm IQC Normal
		"DimmQualityColorrarity1"				"60 131 61 100" // Dimm IQC Genuine
		"DimmQualityColorrarity2"				"141 131 75 100"
		"DimmQualityColorrarity3"				"204 204 250 100"
		"DimmQualityColorrarity4"				"132 42 194 100" // Dimm IQC Unusual
		"DimmQualityColorVintage"				"16 107 245 100" // Dimm IQC Vintage
		"DimmQualityColorUnique"				"255 215 0 100" // Dimm IQC Unique
		"DimmQualityColorCommunity"				"98 174 54 100" // Dimm IQC Community
		"DimmQualityColorDeveloper"				"174 35 132 100" // Dimm IQC Valve
		"DimmQualityColorSelfMade"				"98 174 54 100" // Dimm IQC Community
		"DimmQualityColorCustomized"			"71 98 145 100"
		"DimmQualityColorStrange"				"240 98 44 100" // Dimm IQC Strange
		"DimmQualityColorCompleted"				"134 80 172 100"
		"DimmQualityColorHaunted"				"33 242 174 100" // Dimm IQC Haunted
		"DimmQualityColorCollectors"			"182 0 0 100" // Dimm IQC Collectors
		...
		"ItemRarityMythical"					"134 255 115 255" // IRC Mythical
		"ItemRarityLegendary"					"51 165 171 255" // IRC Legendary
		...
		"DimmItemRarityMythical"					"134 255 115 100" // Dimm IRC Mythical
		"DimmItemRarityLegendary"					"51 165 171 100" // Dimm IRC Legendary
	...
	BaseSettings
	{
		...
		Slider.NobColor				"165 96 179 255" // Highlight color
		Slider.TextColor			"234 216 238 255" // Menu text color
		Slider.TrackColor			"234 216 238 255" // Menu text color
		Slider.DisabledTextColor1	"234 216 238 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"234 216 238 120" // Dimm Menu text color
