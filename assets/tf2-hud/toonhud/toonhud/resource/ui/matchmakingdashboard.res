"Resource/UI/MatchMakingDashboard.res"
{
	...
	"TopBar"
	{
		...
		"ToggleChatButton"
		{
			...
			"image_drawcolor"	"255 255 255 163" // Button icon color
			"image_armedcolor"	"255 255 255 209" // Button icon hover color
		...
		"QueueContainer"
		{
			...
			"CloseButton"
			{
				...
				"defaultFgColor_override" "255 255 255 163" // Button text color
		...
		"ResumeButton"
		{
			...
			"defaultFgColor_override" "255 255 255 163" // Button text color
			"armedFgColor_override" "255 255 255 209" // Button hover text color
			...
			"SubImage"
			{
				...
				"proportionaltoparent"	"1"
				"image"			"icon_resume"
				"image_drawcolor_override"	"255 255 255 163" // Button icon color
				"image_armedcolor_override"	"255 255 255 209" // Button icon hover color
			}
		}
