...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"62 8 80 255" // Active window bg color
		"G_InctiveWindow"			"62 8 80 168" // Inactive window bg color
		"G_TitleBg"					"151 92 164 0" // Title bg color
		"G_TitleText"				"255 228 255 255" // Title text color
		"G_Highlight"				"126 77 201 255" // Highlight color
		"G_ConsoleBg"				"0 0 0 99" // Console bg color
		"G_ListBg"					"0 0 0 99" // List bg color
		"G_Border"					"0 0 0 51" // Border color
		"G_Text"					"255 228 255 255" // Text color
		"G_HighlightText"			"255 255 255 255" // Highlight text color
		"G_SelectedText"			"214 106 238 255" // Selected text color
		"G_DisabledText"			"255 228 255 128" // Disabled text color
		"G_ButtonBg"				"111 73 148 255" // Button bg color
		"G_ButtonText"				"255 228 255 255" // Button text color
		"G_ButtonHoverBg"			"126 77 201 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_InputBg"					"0 0 0 99" // Input bg color
	    ...
	    "QuickListBGSelected"       "126 77 201 255" // Highlight color
